...
<h1 id="titulo" class="center">Painel</h1>
	<div class="row center">
     <a class="waves-effect waves-light btn-large col s2 push-s2" href="entrada.php"><i class="material-icons right medium">archive</i>Entrada</a>
     <a class="waves-effect waves-light btn-large col s2 push-s3" href="saida.php"><i class="material-icons right medium">unarchive</i>Saída</a>
