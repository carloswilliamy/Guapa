...
<html>
  ...
  <br>
    ...
    <div class="container row">
	  	<h5 id="cabeca" class='left col s12 m12 l12 black-text'>Dados Pessoais<i class="material-icons left">person</i></h5>
		<br>
		<br>
        <!--Mude aqui o action-->
        <form class="col s12 m12 l12" action="index.html" method="post">
		<div class="row">
		...
		<h5 id="cabeca" class='left col s12 m 12 l12 black-text'>Dados de contato<i class="material-icons left">contacts</i></h5>
		<div class="row">
